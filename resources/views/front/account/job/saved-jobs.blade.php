                            ...
                            <div class="table-responsive">
                                <table class="table ">
                                    ...
                                    <tbody class="border-0">
                                                        ...
                                                        <div class="action-dots ">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                <li><a class="dropdown-item"
                                                                        href="{{ route('jobDetail', ['jobid' => $savedjob->job->id]) }}">
                                                                        <i class="fa fa-eye" aria-hidden="true"></i>
                                                                        View</a></li>

                                                                <li><a class="dropdown-item"
                                                                        onclick="unsave( {{ $savedjob->id }} )"><i
                                        ...
                                        @else
                                        <tr>
                                            <td colspan="5">You have not saved any jobs yet.</td>
                                        </tr>
                                        @endif
                                    </tbody>
...
@section('customJs')
    <script>
        function unsave(savedjob_id) {
                $.ajax({
                    url: "{{ route('account.jobunSave') }}",
                    type: 'post',
                    dataType: 'json',
                    data: {
