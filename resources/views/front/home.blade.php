                                        ...
                                        <div class="card border-0 p-3 shadow mb-4">
                                            <div class="card-body">
                                                ...
                                                <div class="d-grid mt-3">
                                                    <a href="{{ route('jobDetail',['jobid' =>$fjob->id]) }}" class="btn btn-primary btn-lg">Details</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card border-0 p-3 shadow mb-4">
                                            <div class="card-body">
                                                ...
                                                <div class="d-grid mt-3">
                                                    <a href="{{ route('jobDetail', ['jobid'=>$ljob->id]) }}" class="btn btn-primary btn-lg">Details</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
